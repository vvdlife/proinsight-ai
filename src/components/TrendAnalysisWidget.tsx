            ...
            <div className="flex items-center gap-3">
              <span
                className={`px-2.5 py-1 rounded text-xs font-bold border ${
                  analysis.interestScore > 70
                    ? 'bg-red-50 text-red-600 border-red-100'
                    : analysis.interestScore > 40
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {analysis.relatedKeywords.map((k, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-white border border-slate-200 rounded-lg text-xs text-slate-600 hover:border-indigo-200 hover:text-indigo-600 transition-colors cursor-default"
                    >
                      #{k}
                    </span>
                  ))}
