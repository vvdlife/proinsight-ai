          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden flex flex-col">
            ...
            <div className="p-6 bg-slate-50 border-t border-slate-200 text-right">
              <div className="flex items-center gap-2 mb-4 justify-end">
                ...
                <label
                  htmlFor="dualMode"
                  className="text-sm font-medium text-slate-700 cursor-pointer select-none flex items-center gap-1"
                >
              ...
              <button
                ...
                className={`px-8 py-3 rounded-xl font-bold text-lg shadow-lg flex items-center justify-center gap-3 ml-auto w-full transition-all ${
                  loading.isLoading
