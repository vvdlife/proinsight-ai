        ...
        <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4 mb-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-right">
              ...
              {userLimit && <div className="text-xs text-indigo-500 mt-1">한도: ${userLimit}</div>}
            </div>
          </div>
          ...
          {userLimit && (
            <div className="mt-3">
              <div className="flex items-center justify-between text-xs mb-1">
                ...
                <span
                  className={`font-bold ${usagePercentage > 80 ? 'text-red-600' : 'text-indigo-600'}`}
                >
              ...
              <div className="w-full bg-indigo-100 rounded-full h-2">
                <div
                  className={`h-2 rounded-full transition-all ${
                    usagePercentage > 80 ? 'bg-red-500' : 'bg-indigo-500'
                  }`}
        ...
        <div>
          ...
          <div className="space-y-2 max-h-60 overflow-y-auto">
            {usage.callHistory.slice(0, 10).map((call, idx) => {
              ...
              const estimatedCost =
                (call.promptTokens / 1000) * pricing.input +
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-slate-500">
                    ...
                    <span>
                      {call.totalTokens.toLocaleString()} 토큰 • ${estimatedCost.toFixed(5)}
                    </span>
                  </div>
                </div>
              );
            ...
            {usage.callHistory.length === 0 && (
              <div className="text-center text-slate-400 py-8">아직 API 호출 기록이 없습니다</div>
            )}
          </div>
        </div>
